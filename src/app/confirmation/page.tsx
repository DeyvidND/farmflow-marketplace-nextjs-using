...
export default async function ConfirmationPage({ searchParams }: { searchParams: Promise<{ n?: string }> }) {
    ...
    <StoreShell>
      <div className="mx-auto w-full max-w-xl px-4 py-16 text-center sm:px-6">
        ...
        <div className="mt-7 flex flex-wrap justify-center gap-3">
          <Link href="/shop" className={cn(buttonVariants(), "h-11 rounded-xl font-bold")}>Продължи пазаруването</Link>
